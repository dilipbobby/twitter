	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			try {
				...
				// c =
				// DriverManager.getConnection("dataSource.url","jdbc:postgresql://10.0.14.249:5432/twitter?user=postgres");
				...
				// social_media_types a ,entity_social_media b, persons c where
				// a.sm_type_id=b.sm_type_id and b.entity_id=c.person_id;");
				while (rs.next()) {
